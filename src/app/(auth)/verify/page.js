  ...
  return (
    <div className="shell flex min-h-screen items-center justify-center py-12">
      <Card className="w-full max-w-xl p-8 text-center">
        ...
        <p className="mt-6 text-sm uppercase tracking-[0.2em] text-(--brand-deep)">
          You&apos;re all set
        </p>
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
          <Link
            href="/products"
            className="inline-flex items-center justify-center rounded-full bg-(--ink-900) px-6 py-3 text-sm font-semibold text-white! transition hover:bg-(--brand-deep)]"
          >
            Start shopping
          </Link>
